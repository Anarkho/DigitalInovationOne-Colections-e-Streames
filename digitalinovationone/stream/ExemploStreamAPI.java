package digitalinovationone.stream;
...
public class ExemploStreamAPI {
    public static void main(String[] args) {
        ...
        // Retorna o elemento com maior numeros de letras
        ...
        System.out.println("Não tem nenhum elemento com a letra A minuscúla no nome? "+ estudantes.stream().noneMatch((elemento) -> elemento.contains("a")));
